...
static JNINativeMethod gMethods[] = {
    {"DoFFT", "([DI)V", (void *)Java_brickhack_songbird_android_AndroidLauncher_DoFFT},
};
...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jniRegisterNativeMethods(env, "brickhack/songbird/android/AndroidLauncher", gMethods, 1);
    return JNI_VERSION_1_4;
}

void Java_brickhack_songbird_android_AndroidLauncher_DoFFT(
            JNIEnv* env,
	        jobject thiz,
            jdoubleArray data,
            jint size) {
